...
CREATE TABLE `attendent` (
  ...
  `cert_status` tinyint(1) NOT NULL,
  PRIMARY KEY (`employee_id`),
  CONSTRAINT `attendent_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`)
...
INSERT INTO `attendent` VALUES (16,1),(17,0),(18,1),(19,1),(20,1),(21,1),(22,1),(23,0),(24,1),(25,1),(26,1),(27,1),(28,1),(29,1),(30,1);
